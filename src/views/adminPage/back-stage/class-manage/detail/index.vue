    ...
    <el-main>
      <el-form label-position="left" label-width="120px" :model="tableForm" class="form-box" ref="form" :rules="rules">
        ...
        <el-form-item label="所属学院：" prop="affiliatedCollegeCode">
          <el-select v-model="tableForm.affiliatedCollegeCode" placeholder="请选择" @change="setValue">
            <el-option
        ...
        <el-form-item label="所属专业：" prop="affiliatedMajorCode">
          <el-select v-model="tableForm.affiliatedMajorCode" placeholder="请先选择所属学院" :disabled="!tableForm.affiliatedCollegeCode" @change="getValue">
            <el-option
        ...
        <el-form-item label="学院代码：" prop="classCode">
          <el-input v-model="tableForm.classCode" placeholder="请先选择所属专业" :disabled="!tableForm.affiliatedMajorCode"></el-input>
        </el-form-item>
      </el-form>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        classCode: [{required: true, trigger: 'blur', pattern: /^[0-9]{10}$/, message: '正确编码格式--例:32000101xx'},
