<template>
    <el-main class="main-box">
      <div class="operation-box">
        <el-button type="primary" @click="addOrEdit('/teacher-manage-detail')">新建</el-button>
        <el-button @click="batchDelete(selectedList, true, message)">批量删除</el-button>
      </div>
      <div class="search-box">
        <el-input class="search-input" v-model="searchForm.username" placeholder="请输入教师姓名"></el-input>
      ...
      <el-table
        ...
        <el-table-column prop="employeeNumber" sortable="custom" label="工号"></el-table-column>
        ...
        <el-table-column prop="operation" label="操作">
          <template v-slot="{row}">
            <el-button type="text" class="jh-button-wider" @click="addOrEdit('/teacher-manage-detail', row.id)">修改</el-button>
