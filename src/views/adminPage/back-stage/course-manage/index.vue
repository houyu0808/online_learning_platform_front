<template>
    <el-main class="main-box">
      <div class="operation-box">
        <el-button type="primary" @click="addOrEdit('/course-manage-detail')">新建</el-button>
        <el-button @click="batchDelete(selectedList, true, message)">批量删除</el-button>
      </div>
      <div class="search-box">
        <el-input class="search-input" v-model="searchForm.courseName" placeholder="请输入课程名称"></el-input>
        <el-button type="primary" @click="getList"><i class="el-icon-search"></i>&nbsp;查询</el-button>
        <el-button @click="reset({courseName: ''})">重置</el-button>
      </div>
      <el-table
        :data="tableData"
        border
        ...
        <el-table-column prop="courseName" sortable="custom" label="课程名称"></el-table-column>
        <el-table-column prop="courseCode" sortable="custom" label="课程编号"></el-table-column>
        <el-table-column prop="operation" label="操作">
          <template v-slot="{row}">
            <el-button type="text" class="jh-button-wider" @click="addOrEdit('/course-manage-detail', row.id)">修改</el-button>
...
export default {
  ...
  data () {
    return {
      ...
      message: '删除课程将会删除所有相关信息，确认删除吗？',
      getListApi: api.getCoursePage,
