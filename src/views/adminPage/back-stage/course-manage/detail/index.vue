    ...
    <el-main>
      <el-form label-position="left" label-width="120px" :model="tableForm" class="form-box" ref="form" :rules="rules">
        ...
        <el-form-item label="所属专业：" prop="affiliatedMajorCode">
          <el-select v-model="tableForm.affiliatedMajorCode" placeholder="请先选择所属学院" :disabled="!tableForm.affiliatedCollegeCode">
            <el-option
        ...
        <el-form-item label="授课教师：" prop="teacher">
          <el-select v-model="tableForm.teacher" filterable placeholder="请选择">
            <el-option
  ...
  data () {
    return {
      ...
      rules: {
        ...
        courseCode: [{required: true, trigger: 'blur', pattern: /^3203[0-9]{4}$/, message: '正确编码格式--例:3203xxxx'}],
