<template>
    <el-main class="main-box">
      <div class="operation-box">
        <el-button type="primary" @click="addOrEdit('/college-manage-detail')">新建</el-button>
        <el-button @click="batchDelete(selectedList, true, message)">批量删除</el-button>
      </div>
      <div class="search-box">
        <el-input class="search-input" v-model="searchForm.collegeName" placeholder="请输入学院名称"></el-input>
        <el-button type="primary" @click="getList"><i class="el-icon-search"></i>&nbsp;查询</el-button>
        <el-button @click="reset({collegeName:''})">重置</el-button>
      </div>
      <el-table
        :data="tableData"
        border
        ...
        <el-table-column prop="collegeName" sortable="custom" label="学院名称"></el-table-column>
        <el-table-column prop="collegeCode" sortable="custom" label="学院编号"></el-table-column>
        <el-table-column prop="operation" label="操作">
          <template v-slot="{row}">
            <el-button type="text" class="jh-button-wider" @click="addOrEdit('/college-manage-detail', row.id)">修改</el-button>
...
export default {
  ...
  data () {
    return {
      ...
      message: '删除学院将会删除所有相关信息，确认删除吗？',
      getListApi: api.getCollegePage,
      deleteApi: api.deleteCollege,
