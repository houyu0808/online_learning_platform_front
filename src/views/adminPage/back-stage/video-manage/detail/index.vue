    ...
    <el-main>
      <el-form label-position="left" label-width="120px" :model="tableForm" class="form-box" ref="form" :rules="rules">
        ...
        <el-form-item label="封面图片：">
          ...
          list-type="picture"
          :auto-upload="false">
            <el-button size="small" type="primary" v-if="JSON.stringify(file1) === '{}'">点击上传</el-button>
          </el-upload>
        </el-form-item>
        <el-form-item label="课程视频：">
          <el-upload
            ...
            :file-list="file2"
            :auto-upload="false">
            <el-button size="small" type="primary" v-if="JSON.stringify(file2) === '{}'">点击上传</el-button>
          </el-upload>
        </el-form-item>
        <el-form-item label="授课教师：" prop="belongTeacherCode">
          <el-select v-model="tableForm.belongTeacherCode" filterable placeholder="请输入教师姓名进行筛选">
            <el-option
        ...
        <el-form-item label="课程：" prop="belongCourseCode">
          <el-select v-model="tableForm.belongCourseCode" filterable placeholder="请输入课程名称进行筛选">
            <el-option
  ...
  data () {
    return {
      ...
      rules: {
        ...
        belongCourseCode: [{required: true, trigger: 'blur', message: '必填项'}],
        belongTeacherCode: [{required: true, trigger: 'blur', message: '必填项'}]
      },
      teacherList: [],
      courseList: []
    }
